      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="bg-card border border-border rounded-3xl shadow-sm p-8 sm:p-12">
          ...
          <div className="mb-10 pb-6 border-b border-border">
            <h1 className="font-heading text-4xl font-bold text-foreground tracking-tight mb-2">Privacy Policy</h1>
            <p className="font-body text-[15px] font-normal text-muted-foreground">Quickhands Africa &mdash; Effective Date: March 4, 2026</p>
          </div>

          {/* Intro */}
          <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-10">
          ...
          <div className="space-y-10 text-[15px]">
            ...
            {/* Section 1 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">1. Information We Collect</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">
                We collect the following types of information when you use Quickhands:
              </p>
              <ul className="list-disc list-inside space-y-3 font-body text-[15px] font-normal text-muted-foreground leading-relaxed pl-2">
            ...
            {/* Section 2 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">2. How We Use Your Information</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">We use your information to:</p>
              <ul className="list-disc list-inside space-y-3 font-body text-[15px] font-normal text-muted-foreground leading-relaxed pl-2">
            ...
            {/* Section 3 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">3. Sharing Your Information</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">
            ...
            {/* Section 4 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">4. WhatsApp Integration</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed">
            ...
            {/* Section 5 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">5. Data Storage and Security</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">
            ...
            {/* Section 6 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">6. Data Retention</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed">
            ...
            {/* Section 7 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">7. Your Rights</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">You have the right to:</p>
              <ul className="list-disc list-inside space-y-3 font-body text-[15px] font-normal text-muted-foreground leading-relaxed pl-2">
              ...
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mt-4">
            ...
            {/* Section 8 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">8. Children's Privacy</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed">
            ...
            {/* Section 9 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">9. Third-Party Links</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed">
            ...
            {/* Section 10 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">10. Changes to This Privacy Policy</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed">
            ...
            {/* Section 11 */}
            <section>
              <h2 className="font-heading text-4xl font-bold text-foreground mb-4">11. Contact Us</h2>
              <p className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed mb-4">
                If you have any questions or concerns about this Privacy Policy, please contact us:
              </p>
              <div className="font-body text-[15px] font-normal text-muted-foreground leading-relaxed space-y-2 pl-2 border-l-2 border-primary/20">
